...
const confirmEmail = async (req, res) =>{
    try {
        ...
        await user.save()
        const NEWURL = `https://www.strava.com/oauth/authorize?client_id=128690&redirect_uri=127.0.0.1/home/STRAVALINK?user_id%3D${userId}&response_type=code&scope=activity:read_all`
